...
+CGDO   =1.200e-10 CGSO   =1.200e-10 CGBO   =1.200e-10 
...
*        *** Threshold voltage related model parameters ***
+K1     =6.0549e-01 
+K2     =2.4039e-02 K3     =1.082e+01 K3B    =3.852e+00 
+NPEAK  =2.740e+17 VTH0=4.911e-01
...
+PRT    =0.000e+00 
*        *** Overlap capacitance related and dynamic model parameters   ***
+CGDO   =1.200e-11 CGSO   =1.200e-11 CGBO   =1.200e-10 
+CGDL   =4.0e-10 CGSL   =4.0e-10 CKAPPA =1.701e-00 
+CF     =0.000e+00 ELM    =5.000e+00 
+XPART  =1.000e+00 CLC    =1.000e-15 CLE    =6.000e-01 
*        *** Parasitic resistance and capacitance related model parameters ***
+RDSW   =6.797e+02 
...
+IS     =0.000e+00 N      =1.000e+00 
+DCAPLEV=2         CBD    =0.000e+00 CBS    =0.000e+00 
+CJ     =9.960e-04 CJSW   =3.000e-10 FC     =0.000e+00 
+MJ     =3.400e-01 MJSW   =2.300e-01 TT     =0.000e+00 
...
+CJ     =1.052e-03 M      =3.400e-01 VJ     =6.900e-01 TT     =0.000e+00 
+CJSW   =2.800e-10 MJSW   =2.300e-01 FC     =0.500e+00 
...
*        *** Threshold voltage related model parameters ***
+K1     =8.7089e-01 
+K2     =1.0873e-01 K3     =-3.776e+00 K3B    =-7.691e-02 
+NPEAK  =2.459e+17 VTH0=8.295e-01
...
+PRT    =0.000e+00 
*        *** Overlap capacitance related and dynamic model parameters   ***
+CGDO   =1.080e-10 CGSO   =1.080e-10 CGBO   =1.200e-10 
+CGDL   =2.540e-10 CGSL   =2.540e-10 CKAPPA =6.000e-01 
+CF     =0.000e+00 ELM    =5.000e+00 
+XPART  =1.000e+00 CLC    =1.000e-15 CLE    =6.000e-01 
*        *** Parasitic resistance and capacitance related model parameters ***
+RDSW   =1.390e+03 
...
*        *** Process and parameters extraction related model parameters ***
+TOX    =1.60e-08 NGATE  =0.000e+00 
+NLX    =2.283e-07 
+XL     =0.800e-07 XW     =-1.500e-07 
*        *** Substrate current related model parameters ***
+ALPHA0 =0.000e+00 BETA0  =3.000e+01 
*        *** Noise effect related model parameters ***
...
+IS     =0.000e+00 N      =1.000e+00 
+DCAPLEV=2         CBD    =0.000e+00 CBS    =0.000e+00 
+CJ     =1.053e-03 CJSW   =2.800e-10 FC     =0.000e+00 
+MJ     =3.400e-01 MJSW   =2.300e-01 TT     =0.000e+00 
+XTI    =2.026e+00 PB     =6.900e-01 PBSW   =6.900e-01 
* ----------------------------------------------------------------------
...
*        *** Threshold voltage related model parameters ***
+K1     =1.0129e+00 
+K2     =2.3038e-02 K3     =-1.456e+00 K3B    =-2.664e-01 
+NPEAK  =1.715e+17 VTH0=6.794e-01
...
+PRT    =0.000e+00 
*        *** Overlap capacitance related and dynamic model parameters   ***
+CGDO   =1.000e-12 CGSO   =1.000e-12 CGBO   =1.200e-10 
+CGDL   =4.860e-10 CGSL   =4.860e-10 CKAPPA =1.904e-00 
+CF     =0.000e+00 ELM    =5.000e+00 
+XPART  =1.000e+00 CLC    =1.000e-15 CLE    =6.000e-01 
*        *** Parasitic resistance and capacitance related model parameters ***
+RDSW   =9.631e+02 
...
*        *** Common extrinsic model parameters ***
+ALEV   =2         RLEV   =2         
+RD     =0.000e+00 RS     =0.000e+00 RSH    =8.394e+01 
...
+IS     =0.000e+00 N      =1.000e+00 
+DCAPLEV=2         CBD    =0.000e+00 CBS    =0.000e+00 
+CJ     =9.960e-03 CJSW   =3.000e-10 FC     =0.000e+00 
+MJ     =3.400e-01 MJSW   =2.300e-01 TT     =0.000e+00 
+XTI    =2.030e+00 PB     =6.900e-01 PBSW   =6.900e-01 
* ----------------------------------------------------------------------
...
*        *** Threshold voltage related model parameters ***
+K1     =6.7315e-01 
+K2     =4.2664e-02 K3     =8.317e+00 K3B    =-1.479e+00 
+NPEAK  =9.475e+16 VTH0=-1.091e+00
...
+PRT    =0.000e+00 
*        *** Overlap capacitance related and dynamic model parameters   ***
+CGDO   =9.100e-11 CGSO   =9.100e-11 CGBO   =1.200e-10 
+CGDL   =0.680e-10 CGSL   =0.680e-10 CKAPPA =6.000e-01 
+CF     =0.000e+00 ELM    =5.000e+00 
+XPART  =1.000e+00 CLC    =1.000e-15 CLE    =6.000e-01 
*        *** Parasitic resistance and capacitance related model parameters ***
+RDSW   =1.623e+03 
...
*        *** Common extrinsic model parameters ***
+ALEV   =2         RLEV   =2         
+RD     =0.000e+00 RS     =0.000e+00 RSH    =1.612e+02 
...
+IS     =0.000e+00 N      =1.000e+00 
+DCAPLEV=2         CBD    =0.000e+00 CBS    =0.000e+00 
+CJ     =1.523e-03 CJSW   =3.584e-10 FC     =0.000e+00 
...
*        *** Threshold voltage related model parameters ***
+K1     =7.2972e-01 
+K2     =5.9957e-03 K3     =6.353e+00 K3B    =-3.586e+00 
+NPEAK  =7.898e+16 VTH0=-7.338e-01
...
+PRT    =0.000e+00 
*        *** Overlap capacitance related and dynamic model parameters   ***
+CGDO   =6.400e-11 CGSO   =6.400e-11 CGBO   =1.200e-10 
+CGDL   =1.800e-10 CGSL   =1.800e-10 CKAPPA =1.437e-00 
+CF     =0.000e+00 ELM    =5.000e+00 
+XPART  =1.000e+00 CLC    =1.000e-15 CLE    =6.000e-01 
*        *** Parasitic resistance and capacitance related model parameters ***
+RDSW   =6.353e+02 
...
*        *** Common extrinsic model parameters ***
+ALEV   =2         RLEV   =2         
+RD     =0.000e+00 RS     =0.000e+00 RSH    =1.650e+02 
...
+IS     =0.000e+00 N      =1.000e+00 
+DCAPLEV=2         CBD    =0.000e+00 CBS    =0.000e+00 
+CJ     =1.632e-03 CJSW   =4.200e-10 FC     =0.000e+00 
...
*        *** Threshold voltage related model parameters ***
+K1     =7.5839e-01 
+K2     =-7.193e-02 K3     =2.000e+01 K3B    =-1.275e+00 
+NPEAK  =1.309e+17 VTH0=-5.533e-01
...
+PRT    =0.000e+00 
*        *** Overlap capacitance related and dynamic model parameters   ***
+CGDO   =5.600e-11 CGSO   =5.600e-11 CGBO   =1.200e-10 
+CGDL   =1.21e-10 CGSL   =1.21e-10 CKAPPA =0.564e-00 
+CF     =0.000e+00 ELM    =5.000e+00 
+XPART  =1.000e+00 CLC    =1.000e-15 CLE    =6.000e-01 
*        *** Parasitic resistance and capacitance related model parameters ***
+RDSW   =1.872e+03 
...
+CJ     =1.523e-03 M      =5.600e-01 VJ     =1.020e+00 TT     =0.000e+00 
+CJSW   =3.580e-10 MJSW   =4.300e-01 FC     =0.500e+00 
...
RD D1 D {1.660e+03*4.000e-06/(W)} TC=6.200e-03  
.ENDS MODNH
...
*        *** Threshold voltage related model parameters ***
+K1     =7.8029e-01 
+K2     =-1.846e-02 K3     =-2.240e+00 K3B    =6.954e-01 
+NPEAK  =2.713e+17 VTH0=5.360e-01
...
+PRT    =0.000e+00 
*        *** Overlap capacitance related and dynamic model parameters   ***
+CGDO   =1.340e-10 CGSO   =1.340e-10 CGBO   =1.200e-10 
...
+CJ     =1.000e-04 CJSW   =6.375e-10 FC     =0.000e+00 
...
RD D1 D {1.934e+03*4.000e-06/(W)} TC=6.200e-03  
.ENDS MODNMH
...
*        *** Threshold voltage related model parameters ***
+K1     =1.1431e+00 
+K2     =4.0073e-02 K3     =-2.439e+00 K3B    =4.077e-01 
+NPEAK  =2.411e+17 VTH0=7.549e-01
...
+PRT    =0.000e+00 
*        *** Overlap capacitance related and dynamic model parameters   ***
+CGDO   =1.210e-10 CGSO   =1.210e-10 CGBO   =1.200e-10 
+CGDL   =0.000e+00 CGSL   =0.000e+00 CKAPPA =6.000e-01 
+CF     =0.000e+00 ELM    =5.000e+00 
+XPART  =1.000e+00 CLC    =1.000e-15 CLE    =6.000e-01 
*        *** Parasitic resistance and capacitance related model parameters ***
...
RD D1 D {2.327e+03*4.000e-06/(W+5.446e-07)} TC=6.200e-03  
.ENDS MODNHL
...
*        *** Threshold voltage related model parameters ***
+K1     =5.2325e-01 
+K2     =1.6126e-02 K3     =0.000e+00 K3B    =0.000e+00 
+NPEAK  =1.898e+17 VTH0=4.551e-01
...
+IS     =0.000e+00 N      =1.000e+00 
+DCAPLEV=2         CBD    =0.000e+00 CBS    =0.000e+00 
+CJ     =1.175e-03 CJSW   =3.125e-10 FC     =0.000e+00 
+MJ     =3.400e-01 MJSW   =2.300e-01 TT     =0.000e+00 
...
*        *** Threshold voltage related model parameters ***
+K1     =7.5607e-01 
+K2     =-1.162e-02 K3     =-1.715e+00 K3B    =6.325e-01 
+NPEAK  =2.747e+17 VTH0=5.355e-01
...
+PRT    =0.000e+00 
*        *** Overlap capacitance related and dynamic model parameters   ***
+CGDO   =1.873e-10 CGSO   =1.873e-10 CGBO   =1.200e-10 
+CGDL   =1.348e-10 CGSL   =1.348e-10 CKAPPA =6.000e-01 
+CF     =0.000e+00 ELM    =5.000e+00 
+XPART  =1.000e+00 CLC    =1.000e-15 CLE    =6.000e-01 
*        *** Parasitic resistance and capacitance related model parameters ***
+RDSW   =0.000e+00 
...
*        *** Threshold voltage related model parameters ***
+K1     =-3.435e-01 
+K2     =2.3024e-01 K3     =1.103e+01 K3B    =-7.580e-01 
+NPEAK  =1.800e+17 VTH0=-8.419e-01
+VOFF   =-1.170e-01 DVT0   =1.650e+00 DVT1   =3.868e-01 
+DVT2   =1.659e-02 KETA   =-1.440e-02 
+PSCBE1 =5.000e+09 PSCBE2 =1.000e-04 
+DVT0W  =1.879e-01 DVT1W  =7.335e+04 DVT2W  =-6.312e-03 
...
*        *** Overlap capacitance related and dynamic model parameters   ***
+CGDO   =1.000e-12 CGSO   =1.000e-12 CGBO   =1.200e-10 
+CGDL   =2.898e-10 CGSL   =2.898e-10 CKAPPA =6.000e-01 
+CF     =0.000e+00 ELM    =5.000e+00 
+XPART  =1.000e+00 CLC    =1.000e-15 CLE    =6.000e-01 
*        *** Parasitic resistance and capacitance related model parameters ***
+RDSW   =0.000e+00 
